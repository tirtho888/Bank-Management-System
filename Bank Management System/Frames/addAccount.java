...
public class addAccount extends JFrame implements ActionListener,MouseListener
{
	JPanel panel3;
	...
	public addAccount(user u,users us)
	{
		super("Sign Up page");
		...
		panel3.setBackground(Color.decode("#800080"));

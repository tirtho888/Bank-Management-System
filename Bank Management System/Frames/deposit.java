...
public class deposit extends JFrame implements ActionListener,MouseListener
{
	...
	public deposit(user u,users us)
	{
		super("Deposit Money");
		...
		confirm = new JButton(" Deposit",icon);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==confirm && tk.isEmpty()){
			...
			JOptionPane.showMessageDialog(null,"Taka	 "+tk+"	 Succesfully Deposit ","Deposit!",-1);
